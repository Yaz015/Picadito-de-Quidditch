...
public class CazadorTest {
    ...
    void testMeteGol() {
        cazador1.meteGol();
        assertEquals(10, griffindor.puntos.intValue());
    ...
    @Test
    void testHabilidad() {
        assertEquals(625, cazador1.habilidad().intValue());
        assertEquals(276, cazador2.habilidad().intValue());
    }
    @Test
    void testVelocidadCazador() {
        assertEquals(400, cazador1.velocidadDelJugador().intValue());
        assertEquals(40, cazador2.velocidadDelJugador().intValue());
    }
