...
public class BuscadorTest {
    ...
    void testManejoDeEscoba() {
        assertEquals(1.1111111111111112, buscador.nivelManejoDeEscoba().doubleValue());
        //skills del jugador / su peso.
    }

    @Test
    void testVelocidadDelJugador() {
        assertEquals(111, buscador.velocidadDelJugador().intValue());
    }
